...
python tools/owledge_core.py --project-root /work/customer-app validate-memory --strict
```

4. Build the first generated index:

```bash
python tools/owledge_core.py --project-root /work/customer-app build-memory-index
```
