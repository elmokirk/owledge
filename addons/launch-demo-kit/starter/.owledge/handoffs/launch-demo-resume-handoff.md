...
- Evidence: `.owledge/evidence/launch-demo-before.md`
- Static report: `.owledge/reports/launch-demo/project-memory-cockpit.html`
- Prompt template: `.owledge/templates/launch-demo-next-agent-prompt.md`
