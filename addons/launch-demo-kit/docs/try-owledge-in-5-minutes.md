...
Install this add-on after running `quickstart`, then rebuild the memory index.
The installed evidence, handoff, and static report prove the core before/after
