...
summary: "A PI Agent layer that finds cross-project parallels, trends, repeated agent errors, and central project opportunities from Agent Memory."
concept_tags:
  - "pi-agent"
...
- Produce private or internal reports in `agent-memory/pi-agent/`.
