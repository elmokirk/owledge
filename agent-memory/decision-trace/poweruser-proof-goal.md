---
memory_id: "mem:tenant-local:customer-local:agent-memory-standalone:goal:poweruser-proof-layer"
...
source_hash: ""
edges:
  - target: "mem:tenant-local:customer-local:agent-memory-standalone:idea:poweruser-proof-addons"
    type: "drives"
