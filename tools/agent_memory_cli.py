...
REQUIRED_FILES = [
    ...
    "docs/incremental-index-finalization-sprint.md",
    "docs/reusable-review-evaluation-templates.md",
    "docs/review-workflow-finalization-sprint.md",
    "docs/ai-workos-vault-merge-evaluation.md",
    "docs/ai-workos-vault-adapter-plan.md",
    ...
    "docs/pi-agent-adapter-plan.md",
    "docs/pi-agent-global-intelligence-plan.md",
    "docs/pi-agent-red-team-evaluation-plan.md",
