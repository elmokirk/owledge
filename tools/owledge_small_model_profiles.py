...
def validate(profile:str, capsule_chars:int, tools:list[str], hops:int, retry_count:int, output:dict[str,Any])->dict[str,Any]:
 ...
 if retry_count>p["retries"]: errors.append("retry_limit")
 if retry_count<0: errors.append("invalid_retry_count")
