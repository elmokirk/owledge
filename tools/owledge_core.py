#!/usr/bin/env python
"""Owledge markdown-core tools plus optional control-plane adapter.
...
def active_memory_dir(root: pathlib.Path) -> pathlib.Path:
    """Return the active project memory directory, preferring v0.7 `.owledge/`."""
...
REQUIRED_DIRS = [
    ...
    "plugins/owledge-cowork/.claude-plugin",
    "plugins/owledge-cowork/.codex-plugin",
    "plugins/owledge-cowork/hooks",
    "plugins/owledge-cowork/skills/owledge-principles",
    ...
    "plugins/owledge-cowork/tests/fixtures",
...
REQUIRED_FILES = [
    ...
    ".gitignore",
    ".owledge/README.md",
    ".owledge/templates/agent-session-template.md",
    ".owledge/templates/orchestration-delta-template.md",
    ".owledge/templates/root-review-template.md",
    ".owledge/templates/adr-template.md",
    ".owledge/templates/concept-audit-template.md",
    ".owledge/templates/canonical-memory-template.md",
    ".owledge/templates/compiled-memory-template.md",
    ".owledge/templates/pattern-card-template.md",
    ".owledge/templates/shared-lesson-template.md",
    ".owledge/templates/idea-card-template.md",
    ".owledge/templates/user-context-template.md",
    ".owledge/templates/preference-card-template.md",
    ".owledge/templates/goal-card-template.md",
    ".owledge/templates/daily-note-template.md",
    ".owledge/templates/personal-task-template.md",
    ".owledge/templates/research-card-template.md",
    ".owledge/templates/personal-pattern-template.md",
    ".owledge/templates/coach-report-template.md",
    ".owledge/templates/onboarding-profile-template.md",
    ".owledge/templates/pi-intelligence-report-template.md",
    ".owledge/templates/pi-parallel-report-template.md",
    ".owledge/templates/pi-recurring-error-template.md",
    ".owledge/templates/pi-central-project-template.md",
    ".owledge/templates/evaluation-framework-template.md",
    ".owledge/templates/pi-red-team-evaluation-template.md",
    ".owledge/templates/agent-quality-scorecard-template.md",
    ".owledge/templates/multi-perspective-red-team-review-template.md",
    ".owledge/templates/expert-lens-evaluation-template.md",
    ".owledge/templates/scenario-simulation-evaluation-template.md",
    ".owledge/templates/evaluation-persona-pack-template.md",
    ".owledge/templates/review-to-task-plan-template.md",
    ".owledge/templates/project-index-template.md",
    ".owledge/templates/evidence-template.md",
    ".owledge/templates/handoff-template.md",
    ".owledge/templates/qa-gate-template.md",
    ".owledge/templates/rag-export-manifest-template.json",
    ".owledge/templates/epic-overview-template.md",
    ".owledge/templates/workpackage-template.md",
    ".owledge/templates/techspec-template.md",
    ".owledge/templates/task-card-template.md",
    ".owledge/templates/qa-spec-template.md",
    ".owledge/templates/gate-report-template.md",
    ".owledge/templates/handoff-packet-template.md",
    ".owledge/templates/context-pack-template.md",
    ".owledge/schemas/tenant.schema.json",
    ".owledge/schemas/agent.schema.json",
    ".owledge/schemas/epic.schema.json",
    ".owledge/schemas/workpackage.schema.json",
    ".owledge/schemas/task-card.schema.json",
    ".owledge/schemas/qa-spec.schema.json",
    ".owledge/schemas/gate-report.schema.json",
    ".owledge/schemas/context-pack.schema.json",
    ".owledge/schemas/lightrag-export.schema.json",
    ".owledge/schemas/frontmatter.schema.json",
    ".owledge/schemas/edge.schema.json",
    ".owledge/schemas/canonical-memory.schema.json",
    ".owledge/schemas/compiled-memory.schema.json",
    ".owledge/schemas/pattern-card.schema.json",
    ".owledge/schemas/shared-lesson.schema.json",
    ".owledge/schemas/rag-document.schema.json",
    ".owledge/schemas/graphrag-node.schema.json",
    ".owledge/schemas/graphrag-edge.schema.json",
    ".owledge/schemas/global-user-memory.schema.json",
    ".owledge/schemas/artifact-envelope-v1.schema.json",
    ".owledge/schemas/project-manifest-v1.schema.json",
    ".owledge/schemas/resource-ref-v1.schema.json",
    ".owledge/schemas/settings-v1.schema.json",
    ".owledge/schemas/capability-receipt-v1.schema.json",
    ".owledge/schemas/adapter-manifest-v1.schema.json",
    ".owledge/schemas/work-contract-v1.schema.json",
    ".owledge/schemas/evidence-manifest-v1.schema.json",
    ".owledge/schemas/research-memory-v1.schema.json",
    "tools/owledge.py",
    ...
    "tools/owledge_migration.py",
    "tools/owledge_research_memory.py",
    ...
    "plugins/owledge-cowork/tests/fixtures/session-start.json",
    "plugins/owledge-cowork/tests/fixtures/user-prompt.json",
    "plugins/owledge-cowork/tests/fixtures/post-tool-use.json",
    "plugins/owledge-cowork/tests/fixtures/stop.json",
    "tests/fixtures/retrieval-queries.json",
    "tests/fixtures/retrieval-corpus/.owledge/canonical/memory-lifecycle-policy.md",
    "tests/fixtures/retrieval-corpus/.owledge/canonical/context-pack-objective.md",
    "tests/fixtures/retrieval-corpus/.owledge/canonical/stale-research-signal.md",
    "tests/fixtures/retrieval-corpus/.owledge/compiled/context-pack-scoring.md",
    "tests/fixtures/retrieval-corpus/.owledge/compiled/promotion-audit.md",
    "tests/fixtures/retrieval-corpus/.owledge/patterns/progressive-disclosure-runtime.md",
    "tests/fixtures/retrieval-corpus/.owledge/patterns/cross-project-parallel.md",
    "tests/fixtures/retrieval-corpus/.owledge/lessons/privacy-export-gate.md",
    "tests/fixtures/retrieval-corpus/.owledge/lessons/runtime-rag-safety.md",
    "tests/fixtures/retrieval-corpus/.owledge/decisions/markdown-source-of-truth.md",
    "tests/fixtures/retrieval-corpus/.owledge/compiled/stale-conflict-review.md",
    "skills/owledge-principles/SKILL.md",
    "skills/owledge-principles/references/principles.md",
    "skills/owledge-principles/references/agent-rules.md",
    "skills/owledge-principles/references/mapping-contract.md",
    "skills/owledge-principles/references/security-rules.md",
    "skills/owledge-runtime-bridge/SKILL.md",
    "skills/bootstrap-owledge/SKILL.md",
    ...
    "skills/owledge-autonomous-delivery/SKILL.md",
    ...
    "plugins/owledge-cowork/hooks/hooks.python.json",
    "plugins/owledge-cowork/skills/owledge-principles/SKILL.md",
    "plugins/owledge-cowork/skills/owledge-principles/references/principles.md",
    "plugins/owledge-cowork/skills/owledge-principles/references/agent-rules.md",
    "plugins/owledge-cowork/skills/owledge-principles/references/mapping-contract.md",
    "plugins/owledge-cowork/skills/owledge-principles/references/security-rules.md",
    ...
    "plugins/owledge-cowork/skills/render-memory-report/references/agent-activity-report.md",
    "plugins/owledge-cowork/skills/render-memory-report/references/project-dashboard.md",
    "plugins/owledge-cowork/skills/render-memory-report/references/website-ui-report.md",
    "plugins/owledge-cowork/skills/render-memory-report/references/report-design-systems.md",
    "plugins/owledge-cowork/agents/memory-curator.md",
    "plugins/owledge-cowork/commands/memory-init.md",
    "plugins/owledge-cowork/commands/memory-status.md",
    "plugins/owledge-cowork/commands/memory-doctor.md",
    "plugins/owledge-cowork/commands/memory-report.md",
    ...
    "plugins/owledge-cowork/LICENSE",
    "plugins/owledge-cowork/VERSION",
    "plugins/owledge-cowork/CHANGELOG.md",
...
ADDON_REQUIRED_FILES = [
    ...
    "addons/compliance-light/starter/.owledge/compliance/profile.md",
    "addons/compliance-light/tests/fixtures/minimal-pass/.owledge/compliance/profile.md",
    "addons/compliance-light/tests/fixtures/minimal-pass/.owledge/compliance/registers/processing-activity.md",
    "addons/compliance-light/tests/fixtures/minimal-pass/.owledge/compliance/registers/provider.md",
    "addons/compliance-light/tests/fixtures/minimal-pass/.owledge/compliance/ai-systems/ai-system.md",
    "addons/compliance-light/tests/fixtures/minimal-pass/.owledge/compliance/dpia/dpia-trigger.md",
    "addons/compliance-light/tests/fixtures/missing-provider/.owledge/compliance/profile.md",
    "addons/compliance-light/tests/fixtures/invalid-processing-fields/.owledge/compliance/profile.md",
    "addons/compliance-light/tests/fixtures/invalid-processing-fields/.owledge/compliance/registers/processing-activity.md",
    ...
    "addons/project-snapshot-kit/starter/.owledge/project-snapshot/profile.md",
...
EXPORTABLE_DOC_TYPES = {"project_context", "owledge_entrypoint", "canonical", "compiled", "pattern", "lesson", "adr", "qa", "task", "handoff", "idea", "audience", "research_brief", "research_finding", "brainstorm_candidate"} | GLOBAL_USER_DOC_TYPES
...
RETENTION_DEFAULTS = {
    ...
    "owledge_entrypoint": "long",
    "audience": "standard",
    "research_brief": "standard",
    "research_finding": "standard",
    "brainstorm_candidate": "short",
    "user_context": "long",
    "preference": "standard",
    "goal": "standard",
    "research": "standard",
...
COMPLIANCE_PROFILE_REL = ".owledge/compliance/profile.md"
...
def atomic_write_text(path: pathlib.Path, text: str, encoding: str = "utf-8") -> None:
    ...
    tmp = path.with_name(f".tmp-{uuid.uuid4().hex[:12]}.tmp")
...
REVIEW_WORKFLOW_TYPES = {
    "multi-perspective-red-team": {
        ...
        "output_dir": pathlib.Path(".owledge/reviews"),
...
def run_review_workflow(
    ...
    template_path = active_memory_dir(root) / "templates" / str(config["template"])
    if not template_path.exists():
        template_path = root / "templates" / "owledge" / "templates" / str(config["template"])
    if not template_path.exists():
        template_path = root / "templates" / "owledge" / "templates" / str(config["template"])
    if not template_path.exists():
...
def db_path(root: pathlib.Path) -> pathlib.Path:
    return root / ".agent-control" / "owledge.sqlite"
...
def build_context_pack(conn: sqlite3.Connection, root: pathlib.Path, body: dict[str, Any]) -> dict[str, Any]:
    ...
    for base in [".owledge/decisions", ".owledge/canonical", ".owledge/compiled"]:
        folder = root / base
        if folder.exists():
...
def promote_memory(conn: sqlite3.Connection, root: pathlib.Path, body: dict[str, Any]) -> dict[str, Any]:
    ...
    allowed_targets = {
        "canonical": ".owledge/canonical",
        "compiled": ".owledge/compiled",
        "pattern": ".owledge/patterns",
        "lesson": ".owledge/lessons",
    }
    ...
    with file_lock(root / ".agent-control" / "locks" / f"{promotion_id}.lock", timeout_seconds=60):
        ...
        manifest_dir = active_memory_dir(root) / "evidence" / "promotions"
        manifest = {
    ...
    manifest_rel = str((manifest_dir / f"{promotion_id}.json").relative_to(root)).replace("\\", "/")
    return {"promotion_id": promotion_id, "target_path": str(target_rel).replace("\\", "/"), "source_hash": actual_hash, "manifest_path": manifest_rel}
...
def scan_sensitive_data(root: pathlib.Path) -> dict[str, Any]:
    ...
    sessions_dir = active_memory_dir(root) / "sessions"
    for path in sorted(sessions_dir.glob("**/events.jsonl")) if sessions_dir.exists() else []:
        rel = str(path.relative_to(root)).replace("\\", "/")
...
def memory_doctor(root: pathlib.Path, mode: str = "auto") -> dict[str, Any]:
    ...
    is_kit = ((root / "OWLEDGE.template.md").exists() or (root / "OWLEDGE.template.md").exists()) and (root / "tools" / "owledge_core.py").exists() and (
        (root / ".owledge" / "templates").is_dir()
        or (root / "owledge" / "templates").is_dir()
        or (root / "templates" / "owledge" / "templates").is_dir()
        or (root / "templates" / "owledge" / "templates").is_dir()
    )
    detected_mode = "kit" if is_kit and not (root / "OWLEDGE.md").exists() and not (root / "OWLEDGE.md").exists() else "host"
    ...
    if effective_mode == "kit":
        am_base = root / "templates" / "owledge"
        if not am_base.is_dir():
            am_base = root / "templates" / "owledge"
        add("kit-template-entrypoint", (root / "OWLEDGE.template.md").exists(), "error", "OWLEDGE.template.md is present.", "Restore the kit templates.")
        ...
        add("kit-tools", (root / "tools" / "owledge_core.py").exists(), "error", "Kit CLI exists.", "Restore tools/owledge_core.py.")
    else:
    ...
    global_link_path = am_base / "global-link.json"
...
def compliance_markdown_records(root: pathlib.Path) -> list[dict[str, Any]]:
    base = active_memory_dir(root) / "compliance"
    if not base.exists():
        return []
    records = []
...
def compliance_doctor(root: pathlib.Path) -> dict[str, Any]:
    ...
    add("compliance-mode-light", mode == "light", "error", f"compliance_mode={mode or '[missing]'}", "Set compliance_mode: light in .owledge/compliance/profile.md.")
    ...
    add(
        ...
        "Create a processing activity from .owledge/templates/processing-activity-template.md.",
    )
    ...
    add(
        ...
        "Create a provider registry record from .owledge/templates/provider-registry-template.md.",
    )
    ...
    add(
        ...
        "Create an AI system inventory record from .owledge/templates/ai-system-template.md.",
    )
    ...
    add(
        ...
        "Create a DPIA trigger record from .owledge/templates/dpia-trigger-template.md.",
    )
    ...
    add("compliance-reports-ignored", bool(_gitignore_contains(root, ".owledge/exports/compliance/") or _gitignore_contains(root, ".owledge/exports/compliance/")), "warning", "Compliance reports are ignored by git.", "Add .owledge/exports/compliance/ to .gitignore.")
...
def write_memory_index_outputs(
    ...
    memory_dir = active_memory_dir(root)
    out = memory_dir / "indexes" / "memory-index.jsonl"
    manifest_path = memory_dir / "indexes" / "memory-index-manifest.json"
...
def build_memory_index(root: pathlib.Path, incremental: bool = False, track_tombstones: bool = False) -> dict[str, Any]:
    ...
    out = memory_dir / "indexes" / "memory-index.jsonl"
    manifest_path = memory_dir / "indexes" / "memory-index-manifest.json"
    tombstone_path = memory_dir / "indexes" / "memory-index-tombstones.jsonl"
...
def export_rag_documents(
    ...
    out_dir = active_memory_dir(root) / "exports" / "rag"
    ...
    with file_lock(out_dir / f".{corpus_type}.export.lock", timeout_seconds=60):
        ...
        atomic_write_text(out_dir / f"{corpus_type}-latest.json", json.dumps({"generation_id": generation_id, "documents": str(generation_out.relative_to(root)).replace("\\", "/"), "manifest": str(generation_manifest.relative_to(root)).replace("\\", "/")}, indent=2, sort_keys=True))
    return {
        "path": str(out.relative_to(root)).replace("\\", "/"),
        "rows": len(rows),
        "corpus_type": corpus_type,
        ...
        "generation_id": generation_id,
        "generation_path": str(generation_dir.relative_to(root)).replace("\\", "/"),
        "generation_documents": str(generation_out.relative_to(root)).replace("\\", "/"),
...
def export_lightrag(
    ...
    out_dir = active_memory_dir(root) / "exports" / "lightrag"
    out_dir.mkdir(parents=True, exist_ok=True)
    ...
    with file_lock(out_dir / ".lightrag-export.lock", timeout_seconds=60):
        ...
        atomic_write_text(out_dir / "latest.json", json.dumps({"generation_id": generation_id, "path": str(generation_dir.relative_to(root)).replace("\\", "/"), "manifest": str((generation_dir / "manifest.json").relative_to(root)).replace("\\", "/")}, indent=2, sort_keys=True))
    return {"path": str((out_dir / "lightrag-export.jsonl").relative_to(root)).replace("\\", "/"), "rows": len(export_rows), "manifest": str((out_dir / "manifest.json").relative_to(root)).replace("\\", "/"), "generation_id": generation_id, "generation_path": str(generation_dir.relative_to(root)).replace("\\", "/")}
...
def export_graphrag(
    ...
    out_dir = active_memory_dir(root) / "exports" / "graphrag"
    out_dir.mkdir(parents=True, exist_ok=True)
    ...
    with file_lock(out_dir / ".graphrag-export.lock", timeout_seconds=60):
        ...
        atomic_write_text(out_dir / "latest.json", json.dumps({"generation_id": generation_id, "path": str(generation_dir.relative_to(root)).replace("\\", "/"), "manifest": str((generation_dir / "manifest.json").relative_to(root)).replace("\\", "/")}, indent=2, sort_keys=True))
    return {"nodes": len(nodes), "edges": len(edges), "nodes_path": str((out_dir / "nodes.jsonl").relative_to(root)).replace("\\", "/"), "edges_path": str((out_dir / "edges.jsonl").relative_to(root)).replace("\\", "/"), "manifest": str(manifest_path.relative_to(root)).replace("\\", "/"), "generation_id": generation_id, "generation_path": str(generation_dir.relative_to(root)).replace("\\", "/"), "rejected_counts": rejected}
...
def evaluate_memory_retrieval(
    ...
    out_dir = output_dir or (active_memory_dir(root) / "exports" / "retrieval-eval")
    out_dir.mkdir(parents=True, exist_ok=True)
...
PROJECT_SNAPSHOT_PROFILE_REL = ".owledge/project-snapshot/profile.md"
PROJECT_SNAPSHOT_MANIFEST_REL = ".owledge/project-snapshot/project-snapshot-manifest.json"
PROJECT_STORY_SNAPSHOT_REL = ".owledge/compiled/project-story-snapshot.md"
PROJECT_EXECUTION_SNAPSHOT_REL = ".owledge/compiled/project-execution-snapshot.md"
...
def render_memory_report(
    ...
    out_dir = output_dir or (active_memory_dir(root) / "reports" / "html")
    out_dir.mkdir(parents=True, exist_ok=True)
...
<body>
  <header>
    ...
    <p>{html_escape(label)} generated from Owledge files.</p>
    <div class="meta">
...
def read_memory_index_rows_for_snapshot(root: pathlib.Path) -> tuple[list[dict[str, Any]], bool]:
    index_path = active_memory_dir(root) / "indexes" / "memory-index.jsonl"
...
def project_snapshot_rows(root: pathlib.Path, rows: list[dict[str, Any]], limit: int = 60) -> list[dict[str, Any]]:
    ...
    filtered = [
        ...
        and not str(row.get("source_path", "")).startswith((".owledge/reports/", ".owledge/reports/"))
        and not str(row.get("source_path", "")).startswith((".owledge/project-snapshot/", ".owledge/project-snapshot/"))
    ]
    priority = {
        "project_context": 0,
        "canonical": 1,
...
def scan_project_task_artifacts(root: pathlib.Path) -> list[dict[str, Any]]:
    ...
    memory_plans = active_memory_dir(root) / "plans"
    for base, base_label, durable in [(memory_plans, str(memory_plans.relative_to(root)).replace("\\", "/"), True), (root / "agent-plans", "agent-plans", False)]:
        if not base.exists():
            continue
        for path in sorted(base.rglob("*.md")):
            rel = str(path.relative_to(root)).replace("\\", "/")
            ...
            if item_type not in {"TaskCard", "WorkPackage", "EpicOverview", "Plan", "task", "handoff"} and base_label == "agent-plans":
                item_type = "Plan"
...
def collect_project_snapshot_model(root: pathlib.Path, token_budget: int, allow_large_context: bool) -> dict[str, Any]:
    ...
    for rel in ["README.md", "ROADMAP.md", "OWLEDGE.md", "OWLEDGE.template.md"]:
        path = root / rel
...
def build_project_snapshot(
    ...
    if render_html:
        site_dir = root / ".owledge" / "reports" / "project-site"
        ...
        if changed_only and unchanged_sources and html_exists:
            skipped_files.extend([f".owledge/reports/project-site/{page}" for page in expected_pages])
            html_result = {
                "path": ".owledge/reports/project-site/index.html",
                "paths": [],
...
def project_snapshot_file_href(raw: str) -> str | None:
    ...
    safe_prefix = (
        ...
        or normalized.startswith("/")
        or normalized.startswith(".owledge/")
        or normalized.startswith(".owledge/")
...
def render_project_snapshot_site(
    ...
    design = read_report_design(root)
    generated_at = utc_now()
    out_dir = output_dir or (root / ".owledge" / "reports" / "project-site")
    out_dir.mkdir(parents=True, exist_ok=True)
...
def find_parallels(root: pathlib.Path) -> dict[str, Any]:
    ...
    out = active_memory_dir(root) / "indexes" / "parallel-candidates.jsonl"
    out.parent.mkdir(parents=True, exist_ok=True)
...
def runtime_session_paths(root: pathlib.Path, session_id: str) -> dict[str, pathlib.Path]:
    ...
    session_dir = active_memory_dir(root) / "sessions" / session_slug
    return {
...
This private session artifact was generated by the Owledge runtime plugin.
...
def test_contracts(root: pathlib.Path) -> dict[str, Any]:
    ...
    product_templates = root / "templates" / "owledge"
    if not product_templates.is_dir():
        product_templates = root / "templates" / "owledge"
    is_source_repo = product_templates.is_dir() and (root / "tools" / "owledge.py").is_file()

    def public_label(rel: str) -> str:
        if rel == "OWLEDGE.template.md":
            return "OWLEDGE.template.md"
        if rel.startswith(".owledge/"):
            return ".owledge/" + pathlib.Path(rel).relative_to(".owledge").as_posix()
        return rel

    def resolve_source(rel: str) -> pathlib.Path:
        if is_source_repo and rel.startswith(".owledge/"):
            return product_templates / pathlib.Path(rel).relative_to(".owledge")
        if is_source_repo and rel == "OWLEDGE.template.md":
            return root / "OWLEDGE.template.md"
        if (root / ".owledge").is_dir() and rel.startswith(".owledge/"):
            return root / ".owledge" / pathlib.Path(rel).relative_to(".owledge")
        if (root / "OWLEDGE.md").is_file() and rel == "OWLEDGE.template.md":
            return root / "OWLEDGE.md"
        return root / rel

    for rel in REQUIRED_DIRS:
        add(f"dir:{public_label(rel)}", resolve_source(rel).is_dir(), "Required directory exists.")
    for rel in REQUIRED_FILES:
        add(f"file:{public_label(rel)}", resolve_source(rel).is_file(), "Required file exists.")
    if (root / "addons" / "compliance-light").exists():
        for rel in ADDON_REQUIRED_FILES:
            add(f"file:{public_label(rel)}", resolve_source(rel).is_file(), "Optional add-on file exists.")
    schema_dir = resolve_source(".owledge/schemas")
    ...
    for pattern in [
        ".agent-control/owledge.sqlite*",
        ".agent-control/secrets/",
        ".owledge/tmp/",
        ".owledge/cache/",
        ".owledge/exports/retrieval-eval/",
        ".owledge/exports/finalization-gates/",
        ".owledge/exports/compliance/",
        ".owledge/reports/generated/",
        ".owledge/reports/project-site/",
        ".owledge/project-snapshot/project-snapshot-manifest.json",
        "agent-plans/",
    ]:
        legacy = pattern.replace(".owledge/", ".owledge/")
        add(f"gitignore:{pattern}", pattern in gitignore or legacy in gitignore, "Runtime or scratch path is ignored.")
    ...
    placeholders = []
    for rel in ["OWLEDGE.template.md", "AGENTS.template.md", "CLAUDE.template.md"]:
...
def kit_integrity_check(root: pathlib.Path) -> dict[str, Any]:
    ...
    Uses a negative-list approach: a built kit's ``.owledge/`` tree should
    only contain files that also exist in the product template tree (the
    ...
    """
    am_base = root / ".owledge"
    public_prefix = ".owledge"
    if not am_base.exists():
        am_base = root / "owledge"
        public_prefix = "owledge"
    violations: list[str] = []
    if not am_base.exists():
        return {"passed": True, "violations": [], "checked_files": 0, "method": "no-owledge-memory", "project": str(root)}
    ...
    source_templates = product_template_dir(root)
    if source_templates.is_dir():
        ...
        violations = [f"{public_prefix}/{rel}" for rel in kit_files if rel not in template_files]
        method = f"negative-list ({source_templates.relative_to(root).as_posix()}/ baseline)"
        ...
        for rel in kit_files:
            for pattern in dogfood_globs:
                if _fn.fnmatch(rel, pattern):
                    violations.append(f"{public_prefix}/{rel}")
                    break
...
def addon_boundary_check(root: pathlib.Path) -> dict[str, Any]:
    ...
    checked = 0
    def public_legacy_path(value: str) -> bool:
        normalized = str(value).replace("\\", "/").strip().rstrip("/")
        return normalized == "owledge" or normalized.startswith(".owledge/")
    for addon_path in sorted(addons_dir.glob("*/addon.json")):
        addon_name = addon_path.parent.name
        raw = addon_path.read_bytes()
        if raw.startswith(b"\xef\xbb\xbf"):
            violations.append({"addon": addon_name, "file": str(addon_path.relative_to(root)).replace("\\", "/"), "reason": "utf8-bom"})
        try:
            manifest = json.loads(raw.decode("utf-8-sig"))
        except Exception as exc:
            violations.append({"addon": addon_name, "file": str(addon_path.relative_to(root)).replace("\\", "/"), "reason": f"invalid-json: {exc}"})
            continue
        allowed_prefixes: list[str] = []
        for d in manifest.get("install_directories", []):
            directory = str(d).replace("\\", "/")
            if public_legacy_path(directory):
                violations.append({"addon": addon_name, "file": directory, "reason": "legacy-public-target"})
            allowed_prefixes.append(directory.rstrip("/") + "/")
        for item in manifest.get("install_files", []):
            target = str(item["target"]).replace("\\", "/")
            if public_legacy_path(target):
                violations.append({"addon": addon_name, "file": target, "reason": "legacy-public-target"})
            allowed_prefixes.append(target)
        for item in manifest.get("install_if_parent_exists", []):
            parent = str(item["parent"]).replace("\\", "/")
            if public_legacy_path(parent):
                violations.append({"addon": addon_name, "file": parent, "reason": "legacy-public-parent"})
            target = str(item["target"]).replace("\\", "/")
            if public_legacy_path(target):
                violations.append({"addon": addon_name, "file": target, "reason": "legacy-public-target"})
            allowed_prefixes.append(target)
        for entry in manifest.get("gitignore", []):
            normalized = str(entry).replace("\\", "/")
            if public_legacy_path(normalized):
                violations.append({"addon": addon_name, "file": normalized, "reason": "legacy-public-gitignore"})
        checked += 1
        for item in manifest.get("install_files", []):
            target = str(item["target"]).replace("\\", "/")
...
def source_vs_target_audit(root: pathlib.Path) -> dict[str, Any]:
    """Assert the product template tree has all core dirs and no extra dogfood."""
    templates_am = product_template_dir(root)
    if not templates_am.exists():
        return {"passed": False, "reason": "templates/owledge/ not found", "project": str(root)}
    core_dirs = [
        "context", "canonical", "compiled", "patterns", "lessons", "ideas", "plans",
        "tasks", "workpackages", "reviews", "audiences", "research",
        "research/briefs", "research/sources", "research/findings",
        "research/syntheses", "research/lanes", "decisions",
...
def dogfood_sync_check(root: pathlib.Path) -> dict[str, Any]:
    """Verify internal/owledge/templates/ mirrors product templates/ (one-way)."""
    source_dir = product_template_dir(root) / "templates"
    internal_dir = root / "internal" / "owledge" / "templates"
    if not source_dir.is_dir():
        return {"passed": False, "reason": "templates/owledge/templates/ not found", "project": str(root), "drifted_files": [], "sync_direction": "templates->internal"}
...
def sdist_clean_check(root: pathlib.Path, sdist_glob: str = "dist/owledge-*.tar.gz") -> dict[str, Any]:
    ...
    2. No non-addon ``.owledge/decision-trace/`` dogfood leaks (addons/
    ...
    violations += [f"legacy template leak: {n}" for n in sorted(leaked_legacy_templates)]
    ...
    return {
        ...
        "leaked_legacy_templates": sorted(leaked_legacy_templates),
...
def _concept_audit_dimension_2(root: pathlib.Path, project_mode: str) -> dict[str, Any]:
    ...
    if _project_mode_at_least(project_mode, "side"):
        cowork_plugin = root / "plugins" / "owledge-cowork" / ".claude-plugin" / "plugin.json"
...
def _concept_audit_dimension_3(root: pathlib.Path, project_mode: str) -> dict[str, Any]:
    ...
    if sync_passed:
        findings.append({
            "severity": "info",
            "detail": "dogfood-sync-check passes (internal/owledge/templates/ mirrors templates/owledge/templates/)",
...
def _concept_audit_guided_checklists(project_mode: str) -> dict[str, list[str]]:
    cross_layer = [
        ...
        "Are the never-touch files (OWLEDGE.md, AGENTS.md, CLAUDE.md, USER_CONTEXT.md) byte-identical before and after upgrade --apply --mode=force-templates --yes?",
    ...
    coherence = [
        ...
        "List synonyms (kit vs Owledge vs Owledge). Are they used consistently?",
        "Check version strings: VERSION, templates/owledge/README.md version, OWLEDGE.template.md version, plugin VERSION files. Do they agree?",
    ]
    if _project_mode_at_least(project_mode, "saas"):
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Owledge control plane and harness")
