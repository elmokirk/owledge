---
memory_id: "mem:tenant-local:customer-local:owledge-standalone:decision:poweruser-proof-layer-ships-as-addons"
...
source_hash: ""
edges:
  - target: "mem:tenant-local:customer-local:owledge-standalone:lesson:proof-before-claims"
    type: "teaches"
