...
semantic_title: "Owledge V1 minimal core traceability"
summary: "Authoritative traceability from the Minimal-Core V1 requirements to V1M tickets, gates and inherited completed evidence."
...
# Owledge V1 Minimal Core Traceability

## Authoritative V1M traceability

These rows are the sole active V1 traceability. Hub, enterprise, Pi Tier-1,
LightRAG, Documentation Compiler, supply-chain, remote sync and generic JSONL
export are parked and cannot justify V1M gate completion or product claims.

| V1 requirement | Active tickets | Active gates / inherited evidence |
| --- | --- | --- |
| Control-plane mapping and complexity budget | V1M-01 | G-V1M-PLAN; completed G-081-A referenced |
| Principles, minimal install and eight-verb facade | V1M-02, V1M-03 | G-V1M-SURFACE |
| Local user-global Null-Space, recall and bounded context | V1M-04, V1M-05 | G-V1M-READ |
