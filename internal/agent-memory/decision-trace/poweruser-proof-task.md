---
memory_id: "mem:tenant-local:customer-local:agent-memory-standalone:task:install-poweruser-proof-addons"
...
source_hash: ""
edges:
  - target: "mem:tenant-local:customer-local:agent-memory-standalone:evidence:poweruser-proof-generated-reports"
    type: "evidenced_by"
