---
memory_id: "mem:tenant-local:customer-local:agent-memory-standalone:review:poweruser-proof-qa"
...
source_hash: ""
edges:
  - target: "mem:tenant-local:customer-local:agent-memory-standalone:decision:poweruser-proof-layer-ships-as-addons"
    type: "supports"
