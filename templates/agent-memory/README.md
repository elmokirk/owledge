...
Repeated red-team reviews, senior expert evaluations, scenario simulations, and finalization reviews should use reusable templates in `agent-memory/templates/`.
