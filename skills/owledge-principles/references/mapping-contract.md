# Owledge Map Contract

Use `owledge-map.json` when a user wants Owledge principles applied to
an existing vault structure instead of the default `owledge-module/` folder.
...
- Missing map: use `owledge-module/` fallback.
