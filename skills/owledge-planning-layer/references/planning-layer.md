...
| Signal | Mode |
| --- | --- |
| `agent-memory/` and `tools/agent_memory_cli.py` exist | Project-local Owledge |
| `agent-memory-map.json` exists | Mapped knowledgebase |
| `agent-memory-module/` exists | Drop-in KB module |
