...
class V1M03PublicFacadeTests(unittest.TestCase):
    ...
    def test_unavailable_lifecycle_verbs_and_unknown_ninth_verb_fail_without_dispatch(self) -> None:
        deferred = invoke("propose")
        ...
        self.assertEqual(body["operation"], "propose")
